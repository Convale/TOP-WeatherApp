    ...
    return (
        <div className="weatherContainer">
            ...
            <div className="tempuratureInfo">
                <div className="tempuratureDisplay">{Math.round(props.weatherData.main.temp)} °{(props.fahrenheit === true) ? "F" : "C"}</div>
                <div>Real Feel: {Math.round(props.weatherData.main.feels_like)} °{(props.fahrenheit === true) ? "F" : "C"}</div>
            </div>
            ...
            <div className="otherInfo">
                <div>Low: {Math.round(props.weatherData.main.temp_min)} °{(props.fahrenheit === true) ? "F" : "C"}</div>
                <div>High: {Math.round(props.weatherData.main.temp_max)} °{(props.fahrenheit === true) ? "F" : "C"}</div>
